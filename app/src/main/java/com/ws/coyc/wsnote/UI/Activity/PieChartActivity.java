...
public class PieChartActivity extends AppCompatActivity {
    ...
    private PieChart mChart_person;

    private String[] person_name = new String[6];
    private String[] person_get_from = new String[6];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart_person = (PieChart) findViewById(R.id.chart_person);
        PieData mPieData = getPieData(4);
        showChart(mChart_person,mPieData);
...
//      mChart.setOnAnimationListener(this);
        ...
        pieChart.setCenterText("顾客利润");  //饼状图中间的文字
